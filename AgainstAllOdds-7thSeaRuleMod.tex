...
\begin{document}
	...
	\begin{tikzpicture}[remember picture, overlay]
		\node[inner sep=0pt] at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{AAO-cover.jpg}};
	\end{tikzpicture}
	\clearpage
	...
	greater. For example, if you are trying to keep a crumbling wall from collapsing so that your friends can
	...
	Every use of a magical effect (Sorte, Porte, Sanderis, etc) during an Action Scene costs \textbf{2 AP} --- exactly like a Basic Maneuver.
